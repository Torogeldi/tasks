...
<div class="panel panel-default">
            <div class="panel-heading">
                <h3>Задачи <span class="pull-right">
                </span></h3>
            </div>
            ...
            <div class="panel-body">
                <table class="table table-striped">
                    ...
                    <th width="20%">
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li><a href="/sort-login">По логин</a></li>
                            <li><a href="/sort-email">По email</a></li>
                            <li><a href="/sort-status">По статусу</a></li>
                          </ul>
                        </div>
                    </th>
                    ...
                    <tr>
                        ...
                        <a class="btn btn-primary" href="profile.php?id=<?php echo $data['id']; ?>"><i class="fa fa-eye"></i></a>
